...
public class P_sales_reback_view {
	...
	public P_sales_reback_view() {
		super();
		// TODO Auto-generated constructor stub
	}

	public P_sales_reback_view(String cliname, String discount, String patch, String pillid, double price,
			String productname, int qty, String rebackdate, String rebackid) {
		super();
